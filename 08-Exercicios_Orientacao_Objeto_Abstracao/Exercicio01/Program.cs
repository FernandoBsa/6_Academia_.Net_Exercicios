...
namespace Exercicio01
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Em seguida, criar um método Apresentar na classe Aluno que imprime o nome, a idade e a matrícula do aluno, e um método Apresentar na classe Professor que imprime o nome, 
            //a idade e a disciplina do professor.
